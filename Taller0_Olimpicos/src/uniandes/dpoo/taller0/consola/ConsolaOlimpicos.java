...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consulta adicional");
	...
	/** 
	 * Clase encargada de la consulta especial
	 * 
	 */
	private void ejecutarConsultaAtletaPais()
	{
		String name_1 = input("\n" + "Ingrese el nombre de un atleta");
		Atleta s = calculadora.nombrePorPais(name_1);
		System.out.println("El atleta representa al pais: " + s.darPais().darNombre());
